    ...
    impl CursorTooltip {
        ...
        pub fn load_style(&mut self, path: String) -> Result<(), &str> {
            ...
            let theme = ThemeSet::get_theme(&path)
                .or(Err("Failed to load theme file"))?;
...
// If the webkit feature is disabled provide a dummy implementation of CursorTooltip.
...
#[cfg(feature = "webkit")]
pub use self::with_webkit::*;

#[cfg(not(feature = "webkit"))]
pub use self::without_webkit::*;
